<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
        ...
        <div class="sidebar-brand-text mx-3">SMAKANZA-LIB</div>
    </a>
    ...
    @if (Auth::user()->isAdmin == 1)
        <li class="nav-item">
            ...
            <div id="collapsePeminjam" class="collapse" aria-labelledby="headingPeminjam"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/peminjaman">Riwayat Transaksi</a>
                    <h6 class="collapse-header">Transaksi Peminjaman</h6>
                    <a class="collapse-item" href="/peminjaman/create">Peminjaman Buku</a>
                    <h6 class="collapse-header">Transaksi Pengembalian</h6>
                    <a class="collapse-item" href="/pengembalian">Pengembalian Buku</a>
                </div>
            </div>
        </li>
    @endif
