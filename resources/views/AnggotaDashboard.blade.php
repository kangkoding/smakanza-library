...
<div class="col-xl-3 col-md-6 mb-4">
    ...
    <div class="container">
        ...
        <ol class=text-light>
            ...
            <li class=text-light>Setiap anggota hanya dapat meminjam maksimal 2 buku</li>
            <li class=text-light>Jika pengenbalian buku lebih dari waktu yang ditentukan akan diberikan denda setiap buku Rp.5.000/minggu.</li>
